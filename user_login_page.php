...
?>
	<title>Steak House - User Page</title>
  <meta charset="utf-8">
...
if(isset($_POST['submit']))
{
  ...
  $q = "INSERT INTO reviews (user_name,user_email,user_message) VALUES ('$username',
  '$useremail','$user_message')";
