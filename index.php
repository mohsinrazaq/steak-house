...
<html lang="en">
<head>
	<title>Steak House - Home Page</title>
  <meta charset="utf-8">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="admin_login.php" class="smoothScroll">Admin Login</a></li>
        <li><a href="user_login.php" class="smoothScroll">User Login</a></li>
      </ul>
    </div>
  </div>
</div>
